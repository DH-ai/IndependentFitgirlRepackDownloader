...
urls = [
    # "https://fuckingfast.co/820vu2kleznl#Ghost_of_Tsushima_DC_--_fitgirl-repacks.site_--_.part01.rar",
...
urls = [
    "https://fuckingfast.co/832ro9losuey#fg-selective-japanese.bin",
    "https://fuckingfast.co/ozadxk5703ou#fg-selective-english.bin",
    "https://fuckingfast.co/1ruqxy5tncak#fg-optional-videos.bin",
]
# print(urls)
...
"""
    ...
    1. Adding multi-threading for concurrent downloads. 
        4 files at a time, downlaod them, -> check if they are downloaded properly -> loose the threads and create new threads, for other 4,
